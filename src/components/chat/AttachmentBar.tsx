  ...
  return (
    <div className="flex flex-wrap gap-2 px-4 pb-2">
      {attachments.map((att, index) => (
        <div
          key={att.id}
          className="flex items-center gap-2 pl-2 pr-1 py-1 rounded-lg border border-neutral-200 bg-neutral-50 text-sm group"
        >
          ...
          >
            <X className="h-3.5 w-3.5 text-neutral-400 group-hover:text-neutral-600" />
          </button>
        </div>
      ))}
    </div>
